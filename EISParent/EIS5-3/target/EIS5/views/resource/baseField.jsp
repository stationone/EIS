        ...
        function loadGrid() {
            ...
            $('#mygrid').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'valueScope', title: '取值范围', width: 180, align: 'center'},
        ...
        function deleteField() {
            ...
            if (gridNode == null) {
                ...
                $.messager.confirm("确认", "确认要删除吗？", function (yes) {
                    if (yes) {
                        $.ajax({
                            url: 'baseField/deleteField?id=' + gridNode.id,
                            dataType: 'json',
                            //type: 'post',
                            success: function (data) {
                                //var data = eval('(' + data + ')');
        ...
        <table>
            ...
            <tr>
                ...
                <td><input name="type" class="easyui-validatebox"
                           data-options="required:true,missingMessage:'字段类型不能为空!'"></td>
            </tr>

            <tr>
                <td>取值范围</td>
                <td><input name="valueScope" class="easyui-validatebox"
