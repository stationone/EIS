...
<%--    <script src="js/jquery.easyui.min.1.5.2.js"></script>--%>
    ...
    <script>
        var fileList = [
            ...
            ,{id:'f_21212121452',name:'文件名称3',status:'2'}
            ,{id:'f_21212121232',name:'文件名称4',status:'2'}
            ,{id:'f_212121186212',name:'文件名5称',status:'2'}
            ,{id:'f_212121223612',name:'文件名6称',status:'2'}
            ,{id:'f_212121210792',name:'文件名7称',status:'2'}
            ,{id:'f_212121215642',name:'文件名8称',status:'2'}
